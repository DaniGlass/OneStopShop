...
class PickStop extends Component {
  ...
  getStoreResults() {
    axios.get('https://one-stop-shopsin.herokuapp.com/users/1/results/by_price')
      .then(response => {
    ...
    return (
      <Container>
        <Segment>
          ...
          <Button last active onPress={() => navigate('PickStopByPrice')} style={{backgroundColor: colors.navTabBackground}}>
            <Text style={{color: "white", fontSize: 16, fontWeight: 'bold'}}>By Price</Text>
          </Button>
        </Segment>
