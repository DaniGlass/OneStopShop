...
wetfood2 = Item.create(category: Category.find_by(name: "Pets"), name: "Meow Mix Cat Food Dry Original Choice - 16 Lb", brand: "Meow Mix", description: "The delicious flavors of: chicken, salmon, turkey, ocean fish.", image_url: "https://shop.safeway.com/productimages/200x200/960028148_200x200.jpg", tags: "dry cat food ")
wetfood2.store_prices.create(store_id: 1, price: 13.29)
wetfood2.store_prices.create(store_id: 2, price: 14.19)
wetfood2.store_prices.create(store_id: 3, price: 14.59)
wetfood2.store_prices.create(store_id: 4, price: 13.79)
wetfood2.store_prices.create(store_id: 5, price: 16.69)
wetfood2.store_prices.create(store_id: 6, price: 14.59)
