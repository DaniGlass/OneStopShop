...
paper_towels = Item.create(category: Category.find_by(name: "Home"), name: "Bounty Paper Towels Big Rolls Full Sheet - 12 Roll", brand: "Bounty", description: "2x more absorbent. The quicker picker upper.", image_url: "https://shop.safeway.com/productimages/200x200/960238031_200x200.jpg", tags: "tissues kleenex facial tissue")
...
dry_cat_food.store_prices.create(store_id: 1, price: 13.29)
dry_cat_food.store_prices.create(store_id: 2, price: 14.19)
dry_cat_food.store_prices.create(store_id: 3, price: 14.59)
dry_cat_food.store_prices.create(store_id: 4, price: 13.79)
dry_cat_food.store_prices.create(store_id: 5, price: 16.69)
dry_cat_food.store_prices.create(store_id: 6, price: 14.59)
...
cat_treats.store_prices.create(store_id: 1, price: 13.29)
cat_treats.store_prices.create(store_id: 2, price: 14.19)
cat_treats.store_prices.create(store_id: 3, price: 14.59)
cat_treats.store_prices.create(store_id: 4, price: 13.79)
cat_treats.store_prices.create(store_id: 5, price: 16.69)
cat_treats.store_prices.create(store_id: 6, price: 14.59)

# cat_toy = Item.create(category: Category.find_by(name: "Pets"), name: "Whiskas Temptations Treats for Cats Seafood Medley Flavor - 2.1 Oz", brand: "Temptations", description: "Crunchy outside. Soft inside. Under 2 calories per treat. Stay fresh pouch!", image_url: "https://shop.safeway.com/productimages/200x200/132090132_200x200.jpg", tags: "cat treats ")
# cat_toy.store_prices.create(store_id: 1, price: 13.29)
# cat_toy.store_prices.create(store_id: 2, price: 14.19)
# cat_toy.store_prices.create(store_id: 3, price: 14.59)
# cat_toy.store_prices.create(store_id: 4, price: 13.79)
# cat_toy.store_prices.create(store_id: 5, price: 16.69)
# cat_toy.store_prices.create(store_id: 6, price: 14.59)
